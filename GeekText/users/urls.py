...
from users.views import(password_change_view, registration_view, PropertiesView,
    account_update_view, account_info_view, credit_card_view, CardView, card_registration_view,
)
